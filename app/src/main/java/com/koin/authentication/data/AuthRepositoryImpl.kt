...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun upsertUser(user: UserEntity): Long = withContext(Dispatchers.IO) {
        userDao.upsert(user)
    }

    override suspend fun getUser(userId: Long): UserEntity? = withContext(Dispatchers.IO) {
        userDao.getUser(userId)
    }

    override suspend fun deleteUser(user: UserEntity) = withContext(Dispatchers.IO) {
        userDao.delete(user)
    }
}
