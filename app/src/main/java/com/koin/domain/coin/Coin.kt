...
data class Coin(
    ...
    val formattedPrice: String get() = java.text.NumberFormat.getCurrencyInstance().format(currentPrice)
    ...
    val formattedVolume: String get() = totalVolume?.toLong()?.let { formatLargeNumber(it) } ?: "N/A"
